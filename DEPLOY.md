...
- **Auto-setup** — On first boot, the bot automatically posts and pins the report button (in General). On subsequent restarts, it verifies the post still exists and re-posts if deleted.
